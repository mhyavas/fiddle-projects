...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__18786__auto__){
var self__ = this;
var self__ = this;
var G__45393 = (arguments.length - (1));
switch (G__45393) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args45392){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args45392)));
}));
...
var vec__45397 = temp__5818__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45397,(0),null);
...
var G__45401 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__45401) : f_BANG_.call(null,G__45401));
} else {
return null;
}
});
...
(missionary.impl.Semaphore.Port.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"missionary.impl.Semaphore/Port");
}));

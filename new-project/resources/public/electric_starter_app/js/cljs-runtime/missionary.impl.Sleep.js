...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__18786__auto__){
var self__ = this;
var self__ = this;
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args45418){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args45418)));
}));
...
(missionary.impl.Sleep.Process.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"missionary.impl.Sleep/Process");
}));
...
var G__45429 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__45428 = s.failure;
return (fexpr__45428.cljs$core$IFn$_invoke$arity$1 ? fexpr__45428.cljs$core$IFn$_invoke$arity$1(G__45429) : fexpr__45428.call(null,G__45429));
} else {
return null;
}
});

...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44420 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44420(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44429 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44429(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44430 = (function (reader,ch){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44430(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44431 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44431(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44432 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44432(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44433 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44433(reader);
}
});
...
var G__44448 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44449 = s.append(c);
c = G__44448;
s = G__44449;
continue;
}

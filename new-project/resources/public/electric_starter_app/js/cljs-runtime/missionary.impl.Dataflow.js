...
(missionary.impl.Dataflow.Port.prototype.call = (function (unused__18786__auto__){
var self__ = this;
var self__ = this;
var G__45370 = (arguments.length - (1));
switch (G__45370) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args45369){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args45369)));
}));
...
var _BANG_ = (function (p1__45368_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__45368_SHARP_) : s_BANG_.call(null,p1__45368_SHARP_));
});
...
var G__45375 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__45375) : f_BANG_.call(null,G__45375));
} else {
return null;
}
}
...
(missionary.impl.Dataflow.Port.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"missionary.impl.Dataflow/Port");
}));

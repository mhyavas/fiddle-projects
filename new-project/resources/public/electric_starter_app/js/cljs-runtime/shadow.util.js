...
var len__5722__auto___36335 = arguments.length;
var i__5723__auto___36336 = (0);
while(true){
if((i__5723__auto___36336 < len__5722__auto___36335)){
args_arr__5747__auto__.push((arguments[i__5723__auto___36336]));

var G__36337 = (i__5723__auto___36336 + (1));
i__5723__auto___36336 = G__36337;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq36293){
...
var G__36296 = cljs.core.first(seq36293__$2);
var seq36293__$3 = cljs.core.next(seq36293__$2);
var G__36297 = cljs.core.first(seq36293__$3);
var seq36293__$4 = cljs.core.next(seq36293__$3);
var G__36298 = cljs.core.first(seq36293__$4);
var seq36293__$5 = cljs.core.next(seq36293__$4);
var G__36299 = cljs.core.first(seq36293__$5);
var seq36293__$6 = cljs.core.next(seq36293__$5);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36294,G__36295,G__36296,G__36297,G__36298,G__36299,seq36293__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__36314){
var vec__36315 = p__36314;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36315,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36315,(1),null);

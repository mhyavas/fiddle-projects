...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__18786__auto__){
var self__ = this;
var self__ = this;
var G__45312 = (arguments.length - (1));
switch (G__45312) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args45308){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args45308)));
}));
...
var G__45327 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__45327) : f_BANG_.call(null,G__45327));
} else {
return null;
}
});
} else {
var vec__45328 = temp__5818__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45328,(0),null);
...
var self__ = this;
var _ = this;
var temp__5818__auto__ = cljs.core.seq(self__.writers);
if((temp__5818__auto__ == null)){
var _BANG_ = (function (p1__45306_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__45306_SHARP_) : s_BANG_.call(null,p1__45306_SHARP_));
});
...
var G__45335 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__45335) : f_BANG_.call(null,G__45335));
} else {
return null;
}
});
} else {
var vec__45339 = temp__5818__auto__;
var vec__45342 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45339,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45342,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45342,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
...
(missionary.impl.Rendezvous.Port.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"missionary.impl.Rendezvous/Port");
}));

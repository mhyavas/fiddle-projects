...
var G__43618 = clojure.set.difference.cljs$core$IFn$_invoke$arity$2(xs,ys);
var G__43619 = clojure.set.difference.cljs$core$IFn$_invoke$arity$2(ys,xs);
var G__43620 = env;
return (hyperfiddle.rcf.unify.unify_set.cljs$core$IFn$_invoke$arity$3 ? hyperfiddle.rcf.unify.unify_set.cljs$core$IFn$_invoke$arity$3(G__43618,G__43619,G__43620) : hyperfiddle.rcf.unify.unify_set.call(null,G__43618,G__43619,G__43620));
} else {
var env__$1 = (function (){var G__43621 = cljs.core.first(xs);
var G__43622 = cljs.core.first(ys);
var G__43623 = env;
return (hyperfiddle.rcf.unify.unify.cljs$core$IFn$_invoke$arity$3 ? hyperfiddle.rcf.unify.unify.cljs$core$IFn$_invoke$arity$3(G__43621,G__43622,G__43623) : hyperfiddle.rcf.unify.unify.call(null,G__43621,G__43622,G__43623));
})();
if(hyperfiddle.rcf.unify.failed_QMARK_(env__$1)){
return env__$1;
} else {
var G__43626 = cljs.core.rest(xs);
var G__43627 = cljs.core.rest(ys);
var G__43628 = env__$1;
return (hyperfiddle.rcf.unify.unify.cljs$core$IFn$_invoke$arity$3 ? hyperfiddle.rcf.unify.unify.cljs$core$IFn$_invoke$arity$3(G__43626,G__43627,G__43628) : hyperfiddle.rcf.unify.unify.call(null,G__43626,G__43627,G__43628));
}
}
});
...
var env__$3 = (function (){var G__43635 = cljs.core.find(xs__$1,k);
var G__43636 = cljs.core.find(ys__$1,k);
var G__43637 = env__$2;
return (hyperfiddle.rcf.unify.unify.cljs$core$IFn$_invoke$arity$3 ? hyperfiddle.rcf.unify.unify.cljs$core$IFn$_invoke$arity$3(G__43635,G__43636,G__43637) : hyperfiddle.rcf.unify.unify.call(null,G__43635,G__43636,G__43637));
})();
...
var temp__5816__auto__ = new cljs.core.Keyword("hyperfiddle.rcf.unify","fail","hyperfiddle.rcf.unify/fail",1502173494).cljs$core$IFn$_invoke$arity$1(env);
if(cljs.core.truth_(temp__5816__auto__)){
var fail = temp__5816__auto__;
return ["Failed to unify ",(function (){var temp__5818__auto__ = new cljs.core.Keyword("hyperfiddle.rcf.unify","root","hyperfiddle.rcf.unify/root",-1709721889).cljs$core$IFn$_invoke$arity$1(fail);
if((temp__5818__auto__ == null)){
var vec__43663 = cljs.core.first(fail);
var lvar = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43663,(0),null);
var vec__43666 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43663,(1),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43666,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43666,(1),null);
...
var vec__43669 = temp__5818__auto__;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43669,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43669,(1),null);
...
})(),(function (){var temp__5820__auto__ = cljs.core.seq(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.key,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.map_entry_QMARK_,new cljs.core.Keyword("hyperfiddle.rcf.unify","path","hyperfiddle.rcf.unify/path",-1062026972).cljs$core$IFn$_invoke$arity$1(env))));
if((temp__5820__auto__ == null)){
return null;
} else {
var path = temp__5820__auto__;
